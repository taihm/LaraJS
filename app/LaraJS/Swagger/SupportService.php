 ...
 *              @OA\Schema (
 *                  required={"id", "name"},
 *                  @OA\Property(property="name", type="VARCHAR", default="NONE", example="Trystan Senger", description=""),
     *                  @OA\Property(property="description", type="VARCHAR", default="NULL", example="Austen Pagac", description=""),
     *                  @OA\Property(property="fee", type="DOUBLE", default="NULL", example="6360.5", description=""),
...
class SupportService
{
    ...
    /**
     * <###> @OA\Property(property="description", type="VARCHAR", default="NULL", description="")
     */

    /**
     * <###> @OA\Property(property="fee", type="DOUBLE", default="NULL", description="")
     */
