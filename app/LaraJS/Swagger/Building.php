 ...
 *                  @OA\Property(property="name", type="VARCHAR", default="NONE", example="Marlen Kuhn", description=""),
     *                  @OA\Property(property="address", type="VARCHAR", default="NONE", example="Mustafa Marks Jr.", description=""),
     *                  @OA\Property(property="status", type="INT", default="NULL", example="3656", description=""),
...
class Building
{
    ...
    /**
     * <###> @OA\Property(property="address", type="VARCHAR", default="NONE", description="")
     */

    /**
     * <###> @OA\Property(property="status", type="INT", default="NULL", description="")
     */
